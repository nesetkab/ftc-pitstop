    ...
    <div className="flex flex-col justify-center w-full h-full">
      ...
      >
        ...
        {modules.includes("OPR") && (<div key="OPR">
          <OPRModule opr={data?.targetTeam?.opr} dpr={data?.targetTeam?.dpr} matchesPlayed={data?.targetTeam?.played} loading={loading} error={error} />
        </div>)}
        ...
        {modules.includes("OPR (Small)") && (<div key="OPR (Small)">
          <OPRSmallModule opr={data?.targetTeam?.opr} dpr={data?.targetTeam?.dpr} matchesPlayed={data?.targetTeam?.played} loading={loading} error={error} />
        </div>)}
